...
--[[ -----------------------------------
	...
	resource.AddFile( "materials/iconview.vmt" )
	resource.AddFile( "materials/listview.vmt" )
	resource.AddFile( "materials/iconviewsel.vmt" )
	resource.AddFile( "materials/listviewsel.vmt" )
